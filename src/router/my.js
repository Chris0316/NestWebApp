...
export default [
  ...
  { path: '/my/lives', name: 'MyLives', component: MyLives, meta: { slideLevel: 1, requireAuth: true } },
  { path: '/my/profile', name: 'MyProfile', component: MyProfile, meta: { slideLevel: 1, requireAuth: true } },
  { path: '/my/edit', name: 'MyEdit', component: MyEdit, meta: { slideLevel: 1, requireAuth: true } },
  { path: '/my/message', name: 'MyMessage', component: Message, meta: { slideLevel: 1, requireAuth: true } },
  { path: '/my/message/detail/:id', name: 'MyMessageDetail', component: MsgDetail, meta: { slideLevel: 1, requireAuth: true } },
