...
export default [
  ...
  { path: '/explore/details/:type/:id', name: 'ExploreDetails', component: Details, meta: { slideLevel: 1 } },
  { path: '/explore/publish/:type/:id', name: 'ExplorePublish', component: Publish, meta: { slideLevel: 1 } }
]
